...
See the [README](https://github.com/Opensourcecontri/python-projects/blob/main/README.md) to get an overview of the project and find other necessary information. Here are some great resources to get you comfortable with open source contributions:
